                                                        ...
                                                        <form action="connect.php" method="POST">
                                                            ...
                                                            <!-- <h3>Payment Information</h3>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="cc" class="form-control" onkeypress="if (this.value.length == 16) return false;" placeholder="Enter your Credit Card number">
                                                                    <br>
                                                                    <label for="expiry">Expiry Date:</label>
                                                                    <input type="tel" name="expiry" class="form-control" onkeypress="if (this.value.length == 4) return false;" pattern="0[1-9][2-9]{2}|1[0-2][2-9]{2}" placeholder="Example: 126 [Jan 2026]">
                                                                    <br>
                                                                    <label for="cvv">CVV:</label>
                                                                    <input type="tel" name="cvv" class="form-control" onkeypress="if (this.value.length == 3) return false;" pattern="[0-9]{3}" placeholder="3 digit CVV">
                                                                    <br>
                                                                </div> -->
